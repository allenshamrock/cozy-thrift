...
export default function ProductDetails({ product, reviews }: PropType) {
  ...
  const addSingleProductToCart = useCartStore(
    (state) => state.addSingleProductToCart
  );
  ...
  return (
    <div className="w-full">
      ...
      <p className="my-6 text-2xl md:text-3xl font-bold">
      ...
      <button onClick={() => router.back()} className="underline text-sm mt-6">
        Back
      </button>
    </div>
  );
