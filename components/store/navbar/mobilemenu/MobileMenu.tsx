              ...
              categories.map((cat) => {
                return (
                  <button
                    ...
                    key={cat.id}
                    className={cn(
                      "px-2 pt-4 text-left rounded-md block w-full uppercase font-light  hover:underline transition-smooth",
                      params.get("categorySlug") === cat.slug && "bg-slate-100 "
                    )}
                  >
                    {cat.name}
                  </button>
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      You can log in as a new user if you already have an
                      account or sign up if not or log in as John doe for quick
                      demo.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="flex items-end gap-3 justify-center">
                    ...
                    <DialogClose asChild>
                      <Link
                        onClick={() => setShowNav(false)}
                        className="bg-white border border-primary px-3 py-2 rounded-md shadow-sm text-primary font-semibold text-sm"
