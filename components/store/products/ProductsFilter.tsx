              ...
              categories.map((cat) => {
                return (
                  <button
                    ...
                    key={cat.id}
                    className={cn(
                      "px-2 py-1 text-sm text-left rounded-md block w-full hover:bg-slate-100 transition-smooth",
            ...
            {genderOptions.map((gen) => {
              return (
                <button
                  ...
                  key={gen}
                  className={cn(
                    "h-6 px-2 capitalize rounded-md flex items-center justify-center border border-slate-400 hover:bg-secondary hover:border-transparent hover:text-white transition-smooth text-sm",
