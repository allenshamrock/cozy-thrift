    ...
    <div className="w-full">
      <div className="flex flex-col gap-2 sm:gap-4 mb-4 ">
        ...
        <p className="text-sm opacity-70">
          ...
          apparel designed to meet diverse tastes and styles. From sophisticated
          evening wear to everyday essentials, each piece is carefully curated
          to help you discover and express your unique personality. With a range
          that balances elegance, comfort, and modern trends, our store provides
          an effortless shopping experience tailored to elevate your wardrobe.
        </p>
        <Link href="/store">
          <Button
            label="SHOP NOW"
